...
export default function TokenGeneratorPage() {
  ...
  const generateToken = () => {
    ...
    const token = JWTGenerator.generateTestToken(username, expirationMinutes);
    const url = JWTGenerator.generateTokenURL(username, expirationMinutes);
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <p className="text-xs text-gray-500">
                  Usernames containing "admin" will have admin privileges
                </p>
              </div>
