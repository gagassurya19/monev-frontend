...
export const API_ENDPOINTS = {
  CP: {
    ...
    COURSE_ACTIVITIES: (courseId: number) =>
      `/api/v1/cp/${courseId}/activities`,
    ACTIVITY_DETAIL: (
      courseId: number,
      activityId: number,
      activityType: string
    ) => `/api/v1/cp/${courseId}/${activityType}/${activityId}`,
    ETL: {
  ...
  SAS: {
    ...
    FETCH: {
      ...
      LOGS_SUBJECT_CATEGORIES_FETCH:
        "/api/v1/sas-category-subject/category-subject/logs",
      LOGS_DETAIL_SUBJECT_CATEGORIES:
        "/api/v1/sas-category-subject/logs/{logId}",
      LOGS_REALTIME_SUBJECT_CATEGORIES:
        "/api/v1/sas-category-subject/logs/{logId}/realtime",
    },
    ETL_MONEV: {
  ...
  FINAL_GRADE: {
    ...
    FACULTIES: "/faculties",
    PRODIS: "/prodis",
    COURSES: "/api/v1/final-grade/courses",
  },
  TP: {
    ETL: {
